 ...
 *         static inline const TypedSignal my_signal{"my_signal"};
 *         static inline const TypedSignal<StringName> animation_finished{"animation_finished"};
 *         static inline const TypedSignal<int, float, String, int> many_args{"many_args"};
 *     };
 *
 * public:
...
public:
    ...
    TypedSignal(const char *p_signal_name)
...
private:
    ...
    TypedSignal(const std::string &p_signal_name, size_t p_unbind_arg_count)
        : m_signal_name(p_signal_name)
